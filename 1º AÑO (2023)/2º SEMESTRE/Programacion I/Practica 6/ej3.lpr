...
procedure cantYPorcCons(c:caracteres; var cons:consonantes; var cAlfa:caracAlfa);
var
...
procedure porcDigMayusMin(c:caracteres; var dig:digitos; var mayus:letrasMayus; var min:letrasMin);
var
...
begin
  cargarVector(c,dimL);
  cantYPorcCons(c,cons,cAlfa);
  porcDigMayusMin(c,dig,mayus,min);
  readln;
end.
