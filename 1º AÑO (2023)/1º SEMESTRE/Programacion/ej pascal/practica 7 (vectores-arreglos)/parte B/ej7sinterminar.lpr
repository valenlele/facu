...
begin
  // Inicializar el arreglo tot_empleados
  for oficina_act := 1 to 20 do
    tot_empleados[oficina_act] := 0;

  oficina_act := e[1].oficina;  // Suponemos que el primer empleado pertenece a una oficina válida
  ...
  begin
    ...
    begin
      writeln('El total de empleados de la oficina ', oficina_act, ' es de: ', tot_empleados[oficina_act]);
      oficina_act := e[i].oficina;
      tot_empleados[oficina_act] := 1; // Inicializar con 1 para contar al empleado actual
    end;
  end;

  // Mostrar el total de empleados de la última oficina
  writeln('El total de empleados de la oficina ', oficina_act, ' es de: ', tot_empleados[oficina_act]);
end;
